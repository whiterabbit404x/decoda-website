    ...
    <div className="content-stack">
      ...
      <section className="section-grid">
        <SectionIntro
          ...
          description="RWA Security helps organizations move beyond generic tooling by centering on the specific control, coordination, and reporting needs of tokenized asset businesses."
        />
      ...
      <section className="section-grid two-column-layout">
        <SectionIntro
          ...
          description="RWA programs frequently span legal, operational, and technical boundaries. RWA Security is positioned as the connective security layer for these environments."
        />
      ...
      <section className="section-grid">
        <SectionIntro
          ...
          title="Reserve these modules for RWA Security screenshots."
        ...
        <div className="card-grid two-up">
          <ScreenshotPlaceholder
            title="Insert RWA Security command center screenshot"
            body="Recommended placement for the primary hero visual on this page."
          />
          <ScreenshotPlaceholder
            title="Insert RWA Security workflow detail screenshot"
      ...
      <CTA
        title="Show RWA Security in the context of Decoda&apos;s broader company mission."
